...
public class PotenciaClass extends AppCompatActivity implements
        OnChartGestureListener, OnChartValueSelectedListener {

    ValoresDAO potenciaDao;
    private LineChart mChart;
    private LineDataSet setPotencia;
    float maiorValor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_potencia_class);
        ...
        mChart.setOnChartGestureListener(PotenciaClass.this);
        mChart.setOnChartValueSelectedListener(PotenciaClass.this);
    ...
    public void datasString(){
        potenciaDao = new ValoresDAO(PotenciaClass.this);
        String data = potenciaDao.consultarData();
        potenciaDao.close();
    ...
    public void horariosString (){
        potenciaDao = new ValoresDAO(PotenciaClass.this);
        String h = potenciaDao.consultarHora();
        potenciaDao.close();
    ...
    public void valoresString (){
        potenciaDao = new ValoresDAO(PotenciaClass.this);
        String data = potenciaDao.consultarPotencia();
        potenciaDao.close();
    ...
    public void gerarGráfico () {
        ...
        setPotencia = new LineDataSet(yValues, "Início aquisição " + primeiroValor);

        setPotencia.setFillAlpha(100);

        ArrayList<ILineDataSet> dataSets = new ArrayList<>();
        dataSets.add(setPotencia);

        setPotencia.setColor(Color.GRAY);
        setPotencia.setCircleColor(Color.GRAY);
        setPotencia.setLineWidth(2f);
        setPotencia.setValueTextSize(0f);
