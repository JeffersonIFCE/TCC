...
public class CorrenteClass extends AppCompatActivity implements
        OnChartGestureListener, OnChartValueSelectedListener {

    ValoresDAO correnteDao;
    private LineChart mChart;
    private LineDataSet setCorrente;
    float maiorValor=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_corrente_class);
        ...
        mChart.setOnChartGestureListener(CorrenteClass.this);
        mChart.setOnChartValueSelectedListener(CorrenteClass.this);
    ...
    public void datasString(){
        correnteDao = new ValoresDAO(CorrenteClass.this);
        String data = correnteDao.consultarData();
        correnteDao.close();
        datas = data.split("\n");
    ...
    public void horariosString (){
        correnteDao = new ValoresDAO(CorrenteClass.this);
        String h = correnteDao.consultarHora();
        correnteDao.close();
    ...
    public void valoresString (){
        correnteDao = new ValoresDAO(CorrenteClass.this);
        String data = correnteDao.consultarCorrente();
        correnteDao.close();
    ...
    public void gerarGráfico () {
        ...
        setCorrente = new LineDataSet(yValues, "Início aquisição " + primeiroValor);

        setCorrente.setFillAlpha(100);

        ArrayList<ILineDataSet> dataSets = new ArrayList<>();
        dataSets.add(setCorrente);

        setCorrente.setColor(Color.GRAY);
        setCorrente.setValueTextSize(0f);
        setCorrente.setCircleColor(Color.GRAY);
        setCorrente.setLineWidth(2f);
        //setCorrente.setValueTextColor(Color.BLACK);
