...
public class TemperaturaClass extends AppCompatActivity implements
        OnChartGestureListener, OnChartValueSelectedListener {

    ValoresDAO temperaturaDao;
    private LineChart mChart;
    private LineDataSet setTemperatura;
    float maiorValor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_temperatura_class);
        ...
        mChart.setOnChartGestureListener(TemperaturaClass.this);
        mChart.setOnChartValueSelectedListener(TemperaturaClass.this);
    ...
    public void datasString(){
        temperaturaDao = new ValoresDAO(TemperaturaClass.this);
        String data = temperaturaDao.consultarData();
    ...
    public void horariosString (){
        temperaturaDao = new ValoresDAO(TemperaturaClass.this);
        String h = temperaturaDao.consultarHora();
        temperaturaDao.close();
    ...
    public void valoresString (){
        temperaturaDao = new ValoresDAO(TemperaturaClass.this);
        String data = temperaturaDao.consultarTemperatura();
        temperaturaDao.close();
    ...
    public void gerarGráfico () {
        ...
        setTemperatura = new LineDataSet(yValues, "Início aquisição " + primeiroValor);

        setTemperatura.setFillAlpha(100);

        ArrayList<ILineDataSet> dataSets = new ArrayList<>();
        dataSets.add(setTemperatura);

        setTemperatura.setColor(Color.GRAY);
        setTemperatura.setCircleColor(Color.GRAY);
        setTemperatura.setLineWidth(2f);
        setTemperatura.setValueTextSize(0f);
        //setTemperatura.setValueTextColor(Color.BLACK);
